      ...
      <div className="sidebar-overlay" onClick={() => setShowSidebar(false)}>
        <div className="sidebar-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <ul className="menu-list">
                            <li><Link to="/" className="menu-item"><span>🏠</span> Home</Link></li>
                            <li><Link to="/signin" className="menu-item"><span>📁</span> All Collections</Link></li>
                            <li><Link to="/signin" className="menu-item"><span>👤</span> Account</Link></li>
                            <li><Link to="/signin" className="menu-item"><span>🛒</span> Cart</Link></li>
                            <li><Link to="/signin" className="menu-item"><span>📦</span> My Order</Link></li>
                          </ul>
          <div className="sign-in-section">
            <Link to="/signin"><button className="sign-in-btn">SignIn</button></Link>
          </div>
        </div>
      </div>
    )}
